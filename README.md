...
-Run command which was needed in windows as i have windows os
> Set-ExecutionPolicy Unrestricted -Scope Process
Then run 
>hyperdht --bootstrap --host 127.0.0.1 --port 30001 (keep it running)
Then run
> node server.js (keep it running)
To test
> Run test.js 

### PENDING TASK
> As time was finished I am not able to write logic for fetching records from hyperbee db and find the highest bid and display

### MAJOR CHALLENGES
> The most time taking was setting up for which I have attached screenshots of error and command above to resolve. It took me 3 hours to just resolve that error to make the environment running.
